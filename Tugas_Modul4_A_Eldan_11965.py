...
st.set_page_config(
    page_title="11965 - Unsupervised Learning",
    page_icon="📊",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - Eldan</h1>", unsafe_allow_html=True)
    st.dataframe(input_data)

    model_directory = r'D:\Documents Eliandani\Tugas\Semester 5\Machine Learning\Tugas4_A_11965'
    model_path = {
...
sum_VO = st.sidebar.number_input("Average Visit Online", 0, 16)
